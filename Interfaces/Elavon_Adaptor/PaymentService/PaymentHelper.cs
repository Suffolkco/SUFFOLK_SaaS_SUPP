...
namespace Accela.ACA.PaymentAdapter
{
    ...
    public class PaymentHelper
    {
        ...
        public static void InitialTransaction(Hashtable parameters)
        {
            ...
            transactionModel.payorName = ParameterHelper.GetParameterByKey(parameters, PaymentConstant.FULL_NAME);
        ...
        public static string DoPostBack(string responseUrl, string postData)
        {
            ...
            {
                _logger.Debug("Error occurred when doing postback.", ex);
            }
            finally
            {
                if (myResponse != null)
        ...
        public static string BuildOnlinePaymentURL(Hashtable dynamicKeyValue)
        {
            ...
            {
                parameterBuilder.Replace(pair.Key.ToString(), pair.Value.ToString());
            }
        ...
        public static string BuildOnlinePaymentURL(string hostURL, string parameters, Hashtable dynamicKeyValue) {
            // Get HostURL from config file

            if (String.IsNullOrEmpty(parameters) || String.IsNullOrEmpty(hostURL)) {
                throw new Exception("Can not find HostURL or RedirectURLParameters.");
            }
