// The following automation will synch the Data table on the Parent Env Health Permit with the Data Table on the Violation record
// Also, it will copy the Guidesheet Status and Compliance Date to the Inspection on the Parent Env Health Permit
// The Guidesheet Item Seq No is used to do this automation
eval(getScriptText("EH_Enf_UpdatePermitDataTable"));
eval(getScriptText("EH_Enf_UpdatePermitInspections"));
