...
if (wfTask == "Review form and check that documents are correct" && wfStatus == "Complete")
{
    if (conUpdate == "CHECKED")
    {
		...
		if(contermServ == '1 year')
		{
			datePlusCon = (contractDate.getMonth() +1)+ "/" + contractDate.getDate() + "/" + (contractDate.getFullYear() +1) ;
		}
		else if(contermServ == '3 year')
		{
            datePlusCon = (contractDate.getMonth() +1)+ "/" + contractDate.getDate() + "/" + (contractDate.getFullYear() +3) ;
            			
		}
		else if(contermServ == '5 year')
		{
			datePlusCon = (contractDate.getMonth() +1)+ "/" + contractDate.getDate() + "/" + (contractDate.getFullYear() +5) ;
