...
// Whenenver a new GSR is applied, it should trigger a Call In/Device notification for weights and measures.
var deviceNotification = createChildLocal("ConsumerAffairs", "Weights and Measures", "Call In", "NA", "Created from Retailer Record", capId);
    
if (deviceNotification != null)
{	   
    logDebug("Copy contacts from : " + capId.getCustomID() + " to " + deviceNotification.getCustomID());   
	copyPeople(capId, deviceNotification);    
