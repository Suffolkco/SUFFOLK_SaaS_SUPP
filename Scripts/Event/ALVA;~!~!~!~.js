try
{
    ...
    aa.sendMail("noreply@accela.com", "ryan.littlefield@scubeenterprise.com", "", "debug from alva", debug)
}

catch (error)
{
    aa.sendMail("noreply@accela.com", "ryan.littlefield@scubeenterprise.com", "", "debug from alva", debug + "" + error.message)
