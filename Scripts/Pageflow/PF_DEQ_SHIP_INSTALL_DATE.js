...
var installDate = AInfo["Date of Installation"]
logDebug("installDate = " + installDate);
logDebug("today's date = " + todayDate);
if (new Date(installDate) > startDate)
{
    cancel = true;
    showMessage = true;
    comment("The installation Date must be less than or equal to today's date.");
}
