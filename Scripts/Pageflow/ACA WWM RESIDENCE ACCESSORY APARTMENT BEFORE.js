...
try
{
    ...
    var siteCheck = determineACADocumentAttached("Site Plan/Survey");
	var certCheck = determineACADocumentAttached("Floor Plan");    
    var appCheck = determineACADocumentAttached("Application Checklist");

    if(!siteCheck || !certCheck || !appCheck)
    {       
        cancel = true;
        showMessage = true;
