/*------------------------------------------------------------------------------------------------------/
| Program : ACA TIGHTNESS TESTER DOC ATTACHED.js
| Event   : ACA_Before
|
...
try
{
    ...
    var conCheck = determineACADocumentAttached("Manufacturer Certificate");
    if(!conCheck)
    {       
        cancel = true;
        showMessage = true;
        comment("Document is required for this application; to continue, please attach the 'Manufacturer Certificate'.");
