/*------------------------------------------------------------------------------------------------------/
| Program : ACA TIGHTNESS TEST COMPANY DOC ATTACHED.js
| Event   : ACA_Before
|
...
try
{
    ...
    var certCheck = determineACADocumentAttached("Equipment Certification");    
    var testerCheck = determineACADocumentAttached("List of Testers");

    if(!certCheck || !testerCheck)
    {       
        cancel = true;
        showMessage = true;
        ...
        { 
            cancel = true;
            showMessage = true;
            comment("Equipment Certification");        
        }        
        if(!testerCheck)
        {
            cancel = true;
            showMessage = true;
            comment("List of Testers");
        }
    }   
