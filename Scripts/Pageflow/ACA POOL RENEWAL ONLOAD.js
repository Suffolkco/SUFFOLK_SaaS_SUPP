...
function copy() {
  ...
  var parentCapId = getParent(targetCapId);
    ...
    try {
        ...
        var nysFacility = getAppSpecific("NYS Facility ID", parentCapId);
        var jobNumber = getAppSpecific("Job Number", parentCapId);
        var fileRefNo = getAppSpecific("File Reference Number", parentCapId);
        
        editAppSpecific4ACA("NYS Facility ID", nysFacility, capId);
        editAppSpecific4ACA("Job Number", jobNumber, capId);
        editAppSpecific4ACA("File Reference Number", fileRefNo, capId);
