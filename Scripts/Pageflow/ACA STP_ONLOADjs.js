	...
	copyCapDetailInfo(parentCapId, targetCapId);
       ...
       var childCap = capResult.getOutput().getCapModel();
		...
		var amendCapModel = aa.cap.getCapViewBySingle4ACA(targetCapId);
              ...
              var indsutrialPark = getAppSpecific("Name of Industrial Park, Subdivision, and/or Shopping Center", parentCapId);
              editAppSpecific4ACA("STP Name Industrial Park", indsutrialPark, amendCapModel);
