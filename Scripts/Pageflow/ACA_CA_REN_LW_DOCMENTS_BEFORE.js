/*------------------------------------------------------------------------------------------------------/
| Program : ACA_CA_REN_LW_DOCMENTS_BEFORE.js
...
try
{
    ...
    if (!determineACADocumentAttached("Proof of Continuing Education"))
    {
        docComments += "Proof of Continuing Education" + "<br>";
    }

    if (!determineACADocumentAttached("Truck Photo"))
    {
        docComments += "Truck Photo" + "<br>";
    }

    if (!determineACADocumentAttached("Truck Registration"))
    {
        docComments += "Truck Registration" + "<br>";
    }
