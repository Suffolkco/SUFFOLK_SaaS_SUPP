//To Populate IA Application Number
/*------------------------------------------------------------------------------------------------------/
...
function copy()
{
    ...
    {  
      ...
      copyContactIA(parentCapId, targetCapId);

       var parentAltID = parentCapId.getCustomID();
       var amendCapModel = aa.cap.getCapViewBySingle4ACA(targetCapId);
       var parMan = getAppSpecific("Manufacturer", parentCapId);
       var parMod = getAppSpecific("Model Number", parentCapId);
       var parInDate = getAppSpecific("Installation Date", parentCapId);

       editAppSpecific4ACA("IA Application Number",parentAltID, amendCapModel);
       editAppSpecific4ACA("Manufacturer",parMan, amendCapModel);
       editAppSpecific4ACA("Model Number",parMod, amendCapModel);
       editAppSpecific4ACA("Installation Date",parInDate, amendCapModel);
