/*------------------------------------------------------------------------------------------------------/
| Program : ACA SWIMMING POOL APPLICATION BEFORE.js
...
loadASITables4ACATANK();
    ...
    if(typeof(SWIMMINGPOOLINFORMATION)=="object")
    {
    ...
    else
    {
        cancel = true;
        showMessage = true;
        comment("Swimming Pool Information Missing. Please Enter the Swimming Pool Information.")
    }
}
