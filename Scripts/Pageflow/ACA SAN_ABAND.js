...
function copy()
{
	...
	//copyCapDetailInfo(parentCapId, targetCapId);
       ...
       var capResult = aa.cap.getCap(targetCapId);
       var childCap = capResult.getOutput().getCapModel();
		...
		var amendCapModel = aa.cap.getCapViewBySingle4ACA(targetCapId);
              ...
              var waterSupply = getAppSpecific("Method of Water Supply", parentCapId);
              aa.print("Water supply: " + waterSupply);
              var sewerageSystem = getAppSpecific("Method of Sewage Disposal", parentCapId);
              editAppSpecific4ACA("Method of Water Supply", waterSupply, amendCapModel);
              aa.print("Water supply: " + sewerageSystem);
      
              editAppSpecific4ACA("Method of Sewage Disposal", sewerageSystem, amendCapModel);
