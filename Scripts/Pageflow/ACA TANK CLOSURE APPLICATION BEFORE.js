/*------------------------------------------------------------------------------------------------------/
| Program : ACA TANK CLOSURE APPLICATION BEFORE.js
...
loadASITables4ACATANK();
    ...
    if(typeof(TANKCLOSUREINFORMATION)=="object")
    {
    ...
    else
    {
        cancel = true;
        showMessage = true;
        comment("Tank Information Missing. Please Enter the Tank Closure Information.")
    }
}
