/*------------------------------------------------------------------------------------------------------/
| Program : ACA_CA_REG_RENEW_BEFORE.js
...
try
{
    ...
    if (!determineACADocumentAttached("Pool and Spa Certification Maintenance Specialist Certificate"))
    {
        docComments += "Pool and Spa Certification Maintenance Specialist Certificate" + "<br>";
    }
