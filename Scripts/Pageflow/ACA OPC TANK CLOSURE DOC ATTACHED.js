/*------------------------------------------------------------------------------------------------------/
| Program : ACA OPC TANK CLOSURE APP DOC ATTACHED.js
| Event   : ACA_Before
|
...
try
{
    ...
    var conCheck = determineACADocumentAttached("Work Plan");
    if(!conCheck)
    {       
        cancel = true;
        showMessage = true;
        comment("Document is required for this application; to continue, please attach the 'Work Plan'");
