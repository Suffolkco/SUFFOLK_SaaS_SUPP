/*------------------------------------------------------------------------------------------------------/
| Program : ACA_CA_RESTRICTED_DOCUMENTS_BEFORE.js
...
try
{
    ...
    if (!determineACADocumentAttached("1040 Federal Income Tax Forms"))
    {
        docComments += "1040 Federal Income Tax Forms" + "<br>";
    }
    if (!determineACADocumentAttached("W2 Forms"))
    {
        docComments += "W2 Forms" + "<br>";
    }
    if (!determineACADocumentAttached("Records of Work Experience and Continuing Education"))
    {
        docComments += "Records of Work Experience and Continuing Education" + "<br>";
    }
