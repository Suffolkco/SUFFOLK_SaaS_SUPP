...
var msgMissingPIN = "At least one row is required in the PIN ENTRY list.<br/>";


if(typeof PINENTRY == 'undefined' || PINENTRY == null || PINENTRY.length <= 0){
    validationMessage += msgMissingPIN;
}
