...
if(typeof BANKACCOUNTS == 'undefined' || BANKACCOUNTS == null || BANKACCOUNTS.length <= 0){
    validationMessage += "At least one row is required in Bank Accounts list.<br/>";
}
if(typeof RESTRICTIONS == 'undefined' || RESTRICTIONS == null || RESTRICTIONS.length <= 0){
    validationMessage += "At least one row is required in Restrictions list.<br/>";
}
if(typeof EMPLOYMENT == 'undefined' || EMPLOYMENT == null || EMPLOYMENT.length <= 0){
    validationMessage += "At least one row is required in Employment list.<br/>";
}
if(typeof EDUCATION == 'undefined' || EDUCATION == null || EDUCATION.length <= 0){
    validationMessage += "At least one row is required in Education list.<br/>";
}
