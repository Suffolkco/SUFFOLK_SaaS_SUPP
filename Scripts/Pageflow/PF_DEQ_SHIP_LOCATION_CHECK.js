...
var msgMissingCheck = "At least one location detail is required.<br/>";

var backLeft = AInfo["Backyard - Left"];
var backMid = AInfo["Backyard - Middle"];
var backRight = AInfo["Backyard - Right"]; 
var frontLeft = AInfo["Frontyard - Left"];
var frontMid = AInfo["Frontyard - Middle"];
var frontRight = AInfo["Frontyard - Right"];
var sideLeft = AInfo["Sideyard - Left"];
var sideRight = AInfo["Sideyard - Right"];




if(backLeft != "CHECKED" && backMid != "CHECKED" && backRight != "CHECKED" && frontLeft != "CHECKED" && frontMid != "CHECKED" && frontRight != "CHECKED" && sideLeft != "CHECKED" && sideRight != "CHECKED")
{
    validation = true;
}    
