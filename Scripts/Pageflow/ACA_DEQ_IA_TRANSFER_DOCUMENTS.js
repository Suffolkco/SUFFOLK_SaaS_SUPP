/*------------------------------------------------------------------------------------------------------/
| Program : ACA_DEQ_IA_TRANSFER_DOCUMENTS.js
...
{
    var docComments = "";
    if (!determineACADocumentAttached("O&M Contract"))
    {
        docComments += "O&M Contract" + "<br>";
    }
    if (!determineACADocumentAttached("Sample Result"))
    {
        docComments += "Sample Result" + "<br>";
    }
    if (!determineACADocumentAttached("Service Report"))
    {
        docComments += "Service Report" + "<br>";
    }
