/*------------------------------------------------------------------------------------------------------/
| Program: SwimPoolBiannualFeeEven.js  Trigger: Batch
| Version 1.0 Casey Gray 12/11/2018
| This batch script will be scheduled to run once every year on 10/31 (60 days before expiration), it will only execute on even years
/------------------------------------------------------------------------------------------------------*/
/*------------------------------------------------------------------------------------------------------/
|
			...
			for (var j in recArray) 
			{
				...
				if (cap)
				{
					...
					for (p in poolTable)
					{
						...
						{
							indoorCheck = true;
							//logDebug("We found an indoor pool");
							break;
						}
					}
					...
					if(capmodel.isCompleteCap())
					{
						...
						if (statCheck == true && indoorCheck == true)
						{
...
{
	logDebug("Is is an odd year, not processing outdoor pools");
}
