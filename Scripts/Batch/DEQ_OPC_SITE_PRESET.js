...
{    
    try 
    {
            ...
            if (cap)
            {
                ...
                if (capmodel.isCompleteCap())
                {
					...
					if (pbsSite != "No")
					{
						...
						noChildTankCntPBS++;
						siteNoPBS = siteNoPBS + "," + capIDString;
					}
					
				}
			}
		}
		logDebugLocal("Batch Scipt 1: Total Site-OPC records that has NO child tank with Article 18 that need to update to NO: " + noChildTankCnt18 + ". **** SITE IDS *****: " + siteNo);
		logDebugLocal("Batch Scipt 1: Total Site-OPC records that has NO child tank with PBS that need to update to NO: " + noChildTankCntPBS + ". **** SITE IDS *****: " + siteNoPBS);
	   ...
	   var siteNoPBS = "";
		...
		logDebugLocal("Batch 2: Total Site-OPC records that has a child tank with Article 18 that need to update to NO: " + childTankCnt18 + ". **** SITE IDS *****: " + siteNo);
		logDebugLocal("Batch 2: Total Site-OPC records that has a child tank with PBS that need to update to NO: " + childTankCntPBS + ". **** SITE IDS *****: " + siteNoPBS);
		...
		***********************************************************************/
		...
		logDebugLocal("Batch # 3: Total Site-OPC records that has updated PBS Regulated Site to YES: " + sitePBSSiteSetCnt + ". **** SITE IDS *****: " + siteNoPBS);
		logDebugLocal("Batch # 3: Total Site-OPC records with owner type or MOSF that has updated Artcle 18 to NO: " + siteCnt + + ". **** SITE IDS *****: " + siteNo);
		...
		***********************************************************************/
		...
		var siteNoUnderground = "";
		var siteNoAboveGrnd ="";
		var siteNoHeatingOil = "";
										...
										if (storageType == "0-Tank" || storageType == null)
										{
											...
											prodStoredCat == "Waste/Used/Other Oils") 										
											{
												...
												{													
													...
													{														
														undergroundTotal++;
														siteNoUnderground = siteNoUnderground + "," + capIDString;
												...
												else
												{
													...
													{ 
														if (art18 != 'Yes')
														{
															...
															siteNoAboveGrnd = siteNoAboveGrnd + "," + capIDString;
															exit = true;
											...
											else if (prodStoredCat == "Heating Oils: On-Site Consumption")
											{
												if (capacity > 1100)
												{
													if (art18 != 'Yes')
													{
														...
														siteNoHeatingOil = siteNoHeatingOil + "," + capIDString;
														exit = true;																							
														break;
													}
												}
		...
		logDebugLocal("Batch # 4: Total Site-OPC records that has to update PBS Regulated Site to YES: " + undergroundTotal + ". **** SITE IDS *****: " + siteNoUnderground);
		logDebugLocal("Batch # 4: Total Site-OPC records has to update Artcle 18 to Yes with capacity > 1100: " + abovegroundGreaterThan1100 + ". **** SITE IDS *****: " + siteNoAboveGrnd);
		logDebugLocal("Batch # 4: Total Site-OPC records has to updated Artcle 18 to Yes with heating oil product stored and capacity > 1100: " + heatingOilGreaterThan1100 + ". **** SITE IDS *****: " + siteNoHeatingOil); 
		...
		***********************************************************************/
		...
		logDebugLocal("Batch 5: Total Site-OPC records that has a child tank with Article 18 that need to update to NO: " + childTankCnt18 + ". **** SITE IDS *****: " + siteNo);
		logDebugLocal("Batch 5: Total Site-OPC records that has a child tank with PBS that need to update to NO: " + childTankCntPBS + ". **** SITE IDS *****: " + siteNoPBS); 
	    */
	}
    catch (err) 
    {
