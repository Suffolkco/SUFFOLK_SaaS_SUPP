...
{    
    try 
    {
		...
		var vTankSQL = "SELECT B.B1_ALT_ID as recordNumber FROM B1PERMIT B WHERE B.B1_PER_TYPE = 'OPC' AND B.B1_PER_SUB_TYPE = 'Hazardous Tank' AND B.B1_PER_CATEGORY = 'Permit'";       
