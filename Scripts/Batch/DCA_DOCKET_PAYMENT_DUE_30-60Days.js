/*------------------------------------------------------------------------------------------------------/
| Program:DCA_DOCKET_PAYMENT_DUE_30-60Days.js: Batch
| 
...
if (paramsOK) 
{
    ...
    if (!timeExpired) 
    {
        ...
        aa.sendMail("monthlycalicensingrenewals@suffolkcountyny.gov", emailAddress, "", "Batch Job - DCA_DOCKET_PAYMENT_DUE_30-60Days", emailText);
    }
}
/*------------------------------------------------------------------------------------------------------/
| <===========End Main=Loop================>
						...
						if (workflowResult.getSuccess())
						{
							...
							for (i in wfObj)
							{
								if (wfObj[i].getTaskDescription() == "Payment")
								{
									...
									var conditionName = "Past Due Violation";																
									// Add condition
