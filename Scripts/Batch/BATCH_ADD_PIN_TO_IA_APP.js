/*------------------------------------------------------------------------------------------------------/
| Program: BATCH_ADD_PIN_TO_IA_APP
...
var recTypesList = '';
recTypesList += 'DEQ/Ecology/IA/Application'
...
var pinFieldName = "PIN INFORMATION.IA PIN Number";
/*----------------------------------------------------------------------------------------------------/
|
...
var parmRecordTypeList = recTypesList;
var beginRecDt = "01/01/1990";
var endRecDt = "02/28/2023";
var pinCharLen = 8;
...
function mainProcess() {
    ...
    for (var iii in wrkAr)
    {
        ...
        if (!isTemp)
        {
            ...
            if (editAppSpecificL('PIN INFORMATION.IA PIN Number', pinNumber, capId))
            {
