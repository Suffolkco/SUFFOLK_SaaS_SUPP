/*-------------------------------------------------------------------------------------------------------/
| Program: 30 Day IA Renewal.js  Trigger: Batch
| Version 1.0 Zachary McVicker 01/15/2018
| This batch script will run daily. 
| This will send an email notification to the Property Owner, and add records to the set. 
/------------------------------------------------------------------------------------------------------*/
/*------------------------------------------------------------------------------------------------------/
|
...
var dateLookingFor = new Date(dateAdd((startDate.getMonth() + 1) + "/" + startDate.getDate() + "/" + startDate.getFullYear(), 30));
