/*------------------------------------------------------------------------------------------------------/
| Program:DCA_DOCKET_LICENSED_OBTAINED_DUE_DATE.js: Batch
| 
...
if (paramsOK) 
{
    ...
    if (!timeExpired) 
    {
        ...
        aa.sendMail("monthlycalicensingrenewals@suffolkcountyny.gov", emailAddress, "", "Batch Job - DCA_DOCKET_LICENSED_OBTAINED_DUE_DATE", emailText);
    }
}
/*------------------------------------------------------------------------------------------------------/
| <===========End Main=Loop================>
...
{    
    try 
    {
        ...
        {		
            ...
            obtainedDueDate = vSQLResult[r]["ObtainedDueDate"];
					...
					{						
						...
						if (licenseCapId) 
						{
							...
							else // Add to the list
							{
								if (docketNumbers == "")
								{
									docketNumbers = capIDString;
								}
								else
								{
									docketNumbers = docketNumbers + ", " + capIDString;
								}
							}
						}					
