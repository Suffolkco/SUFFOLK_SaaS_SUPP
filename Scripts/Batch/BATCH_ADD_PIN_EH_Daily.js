/*------------------------------------------------------------------------------------------------------/
        ...
        // Overwritting script to set begin and end date       
        var todayDate = (startDate.getMonth() + 1) + "/" + startDate.getDate() + "/" + startDate.getFullYear();
        logMessage("Today's date: " + todayDate);
        beginRecDt = dateAdd(todayDate, -1);
        ...
        try{
            ...
            logDebug("Begin scan date: " + beginRecDt);
            logDebug("End scan date: " + endRecDt);
            mainProcess();
                ...
                if(asiFieldArray.length > 0){
                    ...
                    if(asiField){
                        ...
                        if(origAsiValue && origAsiValue != null && origAsiValue.trim() != ""){
                            logDebug("SKIPPING ... PIN Value already set for record " + itemCap + " : " + origAsiValue);
                            return false;
                        }
