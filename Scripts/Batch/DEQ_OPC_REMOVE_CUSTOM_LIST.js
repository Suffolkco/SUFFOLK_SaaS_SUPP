/*------------------------------------------------------------------------------------------------------/
| Program:DEQ_WWM_REMOVE_CUSTOM_LIST.js: Batch
| 
| This batch script will run one time to remove old OPC Historical Tank Table custom list
|
/------------------------------------------------------------------------------------------------------*/
/*------------------------------------------------------------------------------------------------------/
...
if (paramsOK) 
{
    ...
    if (!timeExpired) 
    {
        ...
        aa.sendMail("noreplyehimslower@suffolkcountyny.gov", emailAddress, "", "Batch Job - DEQ_OPC_REMOVE_CUSTOM_LIST", emailText);
    }
}
/*------------------------------------------------------------------------------------------------------/
| <===========End Main=Loop================>
...
{    
    try 
    {
		...
		logDebugLocal("Completed. Total of " + count  + " SITE records have OPC Historical Tank Table.");
